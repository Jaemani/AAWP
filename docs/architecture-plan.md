...
S1 Demo의 semantic projection, selection expansion과 executable browser evidence는 `docs/adr/ADR-021-demo-semantic-closure-and-executable-s1.md`를 규범으로 사용한다.
